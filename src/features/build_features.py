...
# For example, if you use it "as is" and extract tokens just by splitting the titles
# by whitespaces, you will see that there are many "weird" tokens like *3.5?*, *
# "Flip*, etc. To prevent the problems, it's usually useful to prepare the data somehow.
